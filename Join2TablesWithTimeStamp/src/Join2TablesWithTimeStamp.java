...
public class Join2TablesWithTimeStamp 
{
    ...
    {    
        ...
        {    
            ...
            for (int i = 0; i < token.length; i++)
            {
           	...
           	userID.set(token[1]);
           	table_PageID_ts.set("1" + "\t" + token[0] + "\t" + token[2]);
        ...
        {    
            ...
            for (Text val : values) 
            {
              	...
              	if (recordCheck[0].equals("1")) 
                {
                   	...
                   	{
                   		PageID_list.add(new Text(recordCheck[1] + "\t" + "\t" + recordCheck[2]));
                   	}
                   	else 
                   	{
                   		PageID_list.add(new Text(recordCheck[1].substring(1) + "\t" + recordCheck[2].substring(1))); 
                   	}
               	}
    ...
    {    
     	...
     	job.setJarByClass(Join2TablesWithTimeStamp.class);
